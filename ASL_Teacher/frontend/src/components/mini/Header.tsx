...
function Header() {
  return (
    <div className="bg-[#121F32] h-[75px] flex justify-between pr-[20px] pl-[20px]">
      ...
      <div className='flex items-center gap-[20px]'>
        <svg aria-label='email' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-white h-2/3">
          <title>email-outline</title>
          <path d="M22 6C22 4.9 21.1 4 20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6M20 6L12 11L4 6H20M20 18H4V8L12 13L20 8V18Z" />
        </svg>
        <svg aria-label='friends' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-white h-2/3">
        ...
        <svg aria-label='settings' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="fill-white h-2/3">
          <title>cog</title>
