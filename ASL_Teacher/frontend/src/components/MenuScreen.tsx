    ...
    <>
      ...
      <Body tailwind="flex gap-[20px] overflow-hidden">
        <div className="flex-1 flex flex-col gap-[30px]">
          ...
          <button 
            className={
                        `bg-gradient-to-r from-[#D9D9D9] to-[#FFFFFF] flex-1 flex items-end p-[20px] text-3xl
                        transition duration-500 ease-in-out
                        hover:translate-x-[100px]`                               
                      }
          ...
          <button 
            className={
                        `bg-gradient-to-r from-[#8C8B8B] to-[#FFFFFF] flex-1 flex items-end p-[20px] text-3xl
                        transition duration-500 ease-in-out
                        hover:translate-x-[100px]`
                      }
          ...
          <button 
            className={
                        `bg-gradient-to-r from-[#433B3B] to-[#1D1818] text-white text-bold flex-2 flex items-end p-[20px] text-3xl
                        transition duration-500 ease-in-out
                        hover:translate-x-[100px]`
                      }
          ...
          <div className="flex-1 flex items-center gap-[30px]">
            <button
              className='bg-[#F6D052] text-3xl flex gap-[10px] items-center flex-3 pt-[20px] pb-[20px] pl-[20px]'
            ...
            <button 
              ...
              className='bg-[#F6D052] flex-1 flex justify-center pt-[20px] pb-[20px]'
